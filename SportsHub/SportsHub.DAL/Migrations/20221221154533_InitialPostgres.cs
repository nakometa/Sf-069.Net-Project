        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticlePicture = table.Column<byte[]>(type: "bytea", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Articles_States_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubLeague", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubLeague_League_LeagueId",
                        column: x => x.LeagueId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubLeague_LeagueId",
                table: "SubLeague",
                column: "LeagueId");

            migrationBuilder.CreateIndex(
                name: "IX_SubLeague_Name",
                table: "SubLeague",
                column: "Name",
                unique: true);
